...
* you need Node.JS v7.0.0 or above installed on your own computer.

* you need MongoDB v3.0.0 or above installed on your own computer.
...
* after installing all project's dependencies run this command in your terminal
```bash
npm start
```
this will run the server for you on localhost:8888

* open your favourite browser on localhost:8888
